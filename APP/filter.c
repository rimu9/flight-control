...
void Low_Passfilter_Init(void)
{

   // imu.caliPass=1;
    //filter rate
    LPF2pSetCutoffFreq_1(100,30);		//30Hz
    LPF2pSetCutoffFreq_2(100,30);
    LPF2pSetCutoffFreq_3(100,30);
    LPF2pSetCutoffFreq_4(100,30);
    LPF2pSetCutoffFreq_5(100,30);
    LPF2pSetCutoffFreq_6(100,30);
}
